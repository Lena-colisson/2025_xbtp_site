...
export default function AboutPage() {
  return (
    <div className="font-sans text-gray-800 bg-white">
      {/* Section Héro */}
      <section className="relative bg-cover bg-center h-90 flex items-center justify-center" style={{ backgroundImage: "url('img/charpente.png')" }}>
        <div className="absolute inset-0 bg-black/60" />
        <h2 className="text-center text-white text-4xl font-bold z-10">Charpente <br />& Couverture</h2>
      </section>
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-6 md:px-8 flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <h2 className="text-3xl font-bold mb-4">Charpente & Couverture : protégez durablement votre maison</h2>
            <p className="text-gray-600 mb-6">
              XBTP prend en charge la pose ou la rénovation de votre toiture : charpente, tuiles, ardoises, zinc, isolation, velux, étanchéité…
<br /> Confiez-nous la structure et l’étanchéité de votre habitat pour un confort optimal en toute saison.
            </p>
